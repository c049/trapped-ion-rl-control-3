...
from trapped_ion_gkp_sim_function import prepare_characteristic_distribution
...
def main():
    ...
    parser.add_argument("--gkp-delta", type=float, default=0.301)
    parser.add_argument("--gkp-logical", type=str, default="0")
    parser.add_argument("--gkp-squeeze-r", type=float, default=None)
    parser.add_argument("--gkp-envelope-kappa", type=float, default=None)
    ...
    char_points, char_target, char_weights = _build_characteristic_distribution(
        ...
        gkp_logical=args.gkp_logical,
        gkp_squeeze_r=args.gkp_squeeze_r,
        gkp_envelope_kappa=args.gkp_envelope_kappa,
        cat_phase=cat_phase,
    )
